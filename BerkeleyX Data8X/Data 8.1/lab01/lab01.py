...
top_1970 = top_1970 = school.select("1970","Row Labels").sort(column_or_label="1970", descending=True)
top_1970
...
top_1970_with_2009 = school.select("1970","2009","Row Labels").sort(column_or_label="1970", descending=True)
top_1970_with_2009
